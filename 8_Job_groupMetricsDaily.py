...
dfnew1 = pd.read_csv('s3://convosight-dev-redshift/config/8_Job_groupMetricsDaily.csv')
...
dfnew1.to_csv ('s3://convosight-dev-redshift/config/8_Job_groupMetricsDaily.csv', index = False, header=True)
s3_target = "s3://convosight-dev-redshift/status_report/8_Job_groupMetricsDaily/"
