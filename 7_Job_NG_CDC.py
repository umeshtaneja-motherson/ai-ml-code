...
for i in range(no_of_table):
    try:
        ...
        print(post_query1)
        datasink1 = glueContext.write_dynamic_frame.from_jdbc_conf(frame = new_df, catalog_connection = "dynamodb_to_redshift", connection_options = {"preactions":pre_query1,"dbtable":redshift_table_main, "database": "convosight_dev_dynamo_data","postactions":post_query1}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink1")
        ...
        for item in list_cols :
            ...
            print(post_query2)
            datasink2 = glueContext.write_dynamic_frame.from_jdbc_conf(frame = new_df_1, catalog_connection = "dynamodb_to_redshift", connection_options = {"preactions":pre_query2,"dbtable":sub_table_name, "database": "convosight_dev_dynamo_data","postactions":post_query2}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink2")
